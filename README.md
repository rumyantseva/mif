...
- [Запуск сервера REST API](#Запуск-REST-API)
- [Формат REST API](#Документация-по-REST-API)
...
Можно воспользоваться готовым дампом из [db](db) или задать структуру базы данных, используя нижеследующее описание. В случае развертывания сервиса из Docker-образов (см. инструкцию ниже), дамп базы накатывается автоматически.
...
- Makefile с набором полезных команд
- Поддержка HTTPS
