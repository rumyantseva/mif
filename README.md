Этот репозиторий прдеставляет собой реализацию неофициального REST API для книг издательства [МИФ](http://mann-ivanov-ferber.ru).
...
- Dockerfile для развертывания сервиса в контейнере
